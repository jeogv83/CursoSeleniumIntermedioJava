...
public class JyperionListener implements ITestListener {
    ...
    public void onTestFailure(ITestResult result) {
         ...
         * desde aqui se crearan los screenshot para cuando se genera un erros, y se indicara que los envie en .PDF
         */
        //Donde se va a localizar el archivo y su nombre(se le agregara un nume aleatorio(Random) para que no se sobreescriba)
        ...
        if (throwable != null) {
            ...
            //Indicar el archivo que se debe desplegar
            imdb.setAction(new PdfAction("file:///" + file));
            //Le decimos que nos indique la expeción en cada parrafo
            Paragraph exep = new Paragraph(throwable.toString());
            exep.add(imdb);
            cell = new PdfPCell(cell);// se agrega a una nueva celda
            this.failTable.addCell(cell);
